...
class AppTheme {
  ...
  static TextTheme get _textDarkTheme {
    return TextTheme(
      headline1: AppTextStyle.headline1.copyWith(color: AppColors.white71),
      headline2: AppTextStyle.headline2.copyWith(color: AppColors.white71),
      headline3: AppTextStyle.headline3.copyWith(color: AppColors.white71),
      headline4: AppTextStyle.headline4.copyWith(color: AppColors.white71),
      headline5: AppTextStyle.headline5.copyWith(color: AppColors.white71),
      headline6: AppTextStyle.headline6.copyWith(color: AppColors.white71),
      subtitle1: AppTextStyle.subtitle1.copyWith(color: AppColors.white71),
      subtitle2: AppTextStyle.subtitle2.copyWith(color: AppColors.white71),
      bodyText1: AppTextStyle.bodyText1.copyWith(color: AppColors.white71),
      bodyText2: AppTextStyle.bodyText2.copyWith(color: AppColors.white71),
      caption: AppTextStyle.caption.copyWith(color: AppColors.white71),
      overline: AppTextStyle.overline.copyWith(color: AppColors.white71),
      button: AppTextStyle.button.copyWith(color: AppColors.white71),
    );
  }
